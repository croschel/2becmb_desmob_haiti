...
<form class="jotform-form" action="2becmb_balterar_sit_mnt.php" method="post" name="teste"  enctype="multipart/form-data" id="" accept-charset="utf-8" novalidate="true">
	  ...
	  <li class="backcolor" data-type="control_text" id="id_56">
        <div id="cid_56" class="form-input-wide">
          <div id="text_56" class="form-html">
			...
			<tr><td><font color='#000000' face="verdana" size=2><b>Situação da Mnt: &nbsp </b></font><select name='sit_mnt'><?php
			echo "<option value=''>Listar</option>";
			echo "<option value='1'>Disponível</option>";
			echo "<option value='0'>Indisponível</option>";
			echo "<option value='2'>Manutenção</option>";
			?>
			</select></td></tr>
