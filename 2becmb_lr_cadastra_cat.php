...
<form class="jotform-form" action="2becmb_lr_cadastrar_cat.php" method="post" name="teste"  enctype="multipart/form-data" id="" accept-charset="utf-8" novalidate="true">
	  ...
	  <li class="backcolor" data-type="control_text" id="id_56">
        <div id="cid_56" class="form-input-wide">
          <div id="text_56" class="form-html">
			...
			<!--tr><td><?php //echo '<font color="#000000" face="verdana" size=2><b>Anexar Doc: &nbsp </b></font></td><td><input type="file" name="arquivo" />';?></td></tr-->
			
			<tr><td><font color='#000000' face="verdana" size=2><b>Título: &nbsp </b></font></td><td><input name="titulo_cat" type="varchar" size="30" value="<?php ?>"></td></tr>
			
			<tr><td><font color='#000000' face="verdana" size=2><b>Endereço Eletrônico: &nbsp </b></font></td><td><input name="link_cat" type="varchar" size="30" value="<?php ?>"></td></tr>
			
			<tr><td><font color='#000000' face="verdana" size=2><b>Observação: &nbsp </b></font></td><td><input name="obs_cat" type="varchar" size="30" value="<?php ?>"></td></tr>
