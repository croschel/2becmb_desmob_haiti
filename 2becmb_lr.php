	  ...
	  <li class="backcolor" data-type="control_text" id="id_56">
        <div id="cid_56" class="form-input-wide">
          <div id="text_56" class="form-html">
			...
			<legend><img src="imagens/lr_faixa.png" width="80%" height="40" border="0"></legend>

			<table align="center" cellpadding="4">			
			
			<tr><td rowspan="7"><img src="./2becmb_foto/<?php echo $a1.'.jpg';?>" width="200" height="250"></td><td><font color='#000000' face="verdana" size=2>Id:</font></td><td><input name="id" type="text" id="id" value="<?php echo $a1;?>" readonly></td></tr>
			...
			<tr><td colspan="3" align="center"><?php echo '<a href="2becmb_ficha.php?id_mat='.$a1.'" target="blank"><img src="./imagens/relatorio.png" width="90" height="90" title="Ficha de Vtr/Eqp"></a>&nbsp&nbsp&nbsp&nbsp';?>
				<?php echo '<a href="2becmb_lr_comb.php?id_mat='.$a1.'" target="blank"><img src="./imagens/combustivel.png" width="90" height="90" title="Abastecimento"></a>&nbsp&nbsp&nbsp&nbsp';?>
				<?php echo '<a href="2becmb_lr_os.php?id='.$a1.'" target="blank"><img src="./imagens/mnt.png" width="90" height="90" title="Manutenção"></a>&nbsp&nbsp&nbsp&nbsp';?>
				<?php echo '<a href="2becmb_lr_cat.php?id='.$a1.'" target="blank"><img src="./imagens/cat.png" width="90" height="90" title="Catálogos"></a>&nbsp&nbsp&nbsp&nbsp';?>
				<?php echo '<a href="2becmb_lr_man.php?id='.$a1.'" target="blank"><img src="./imagens/man.png" width="90" height="90" title="Manuais"></a>&nbsp&nbsp&nbsp&nbsp';?>
				</tr>
