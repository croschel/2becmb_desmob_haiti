	  ...
	  <li class="backcolor" data-type="control_text" id="id_56">
        <div id="cid_56" class="form-input-wide">
          <div id="text_56" class="form-html">
			...
			<legend><img src="imagens/manuais_faixa.png" width="80%" height="40" border="0"></legend>
			...
			<td colspan="4" align="center">
				<?php echo '<a href="2becmb_lr_cadastra_man.php?id_mat='.$a1.'" target="blank"><img src="./imagens/cad_man.png" width="40" height="40" title="Adicionar Manuais"></a>&nbsp&nbsp&nbsp&nbsp';?>
				</td>
			</tr>
...
// consulta com filtros
	$sql1 = "SELECT * FROM 2becmb_lr_man WHERE id_mat LIKE '$a1' ORDER BY titulo_man";
	$query1 = mysqli_query($link, $sql1);	

while ($resultado = mysqli_fetch_assoc($query1)) {
  $id_mat = $resultado['id_mat'];
  $titulo_man = utf8_encode($resultado['titulo_man']);
  $link_man = utf8_encode($resultado['link_man']);
  $obs_man = utf8_encode($resultado['obs_man']);
...
<tr bgcolor="<?php print $cor;?>" >
  ...
  <td><p align="center"><font size=2 color="#000000" face="arial"><a href="<?php echo $link_man; ?>"><?php echo $titulo_man;?></a></font></p></td>
    
  <td><p align="center"><font size=2 color="#000000" face="arial"><?php echo $obs_man;?></font></p></td>
