...
<link rel="shortcut icon" href="http://localhost/2becmb_desmob_haiti/imagens/favicon.ico">
<style type="text/css">
 .backcolor1 {
 /* Firefox 3.6+ */
...
<form class="jotform-form" action="login_verifica_usuario.php" method="post" name="teste" id="" accept-charset="utf-8" novalidate="true">
	  ...
	  <li class="backcolor1" data-type="control_text" id="id_56">
        <div id="cid_56" class="form-input-wide">
          <div id="text_56" class="form-html">
			...
			<legend><font color='#000000' face="verdana" size=2><img src="imagens/login_faixa.png" width="80%" height="50" border="0"></font></legend>

			<table align="center" cellpadding="4">
			<tr><br><td><img src="./imagens/usuario.png" width="50" height="50" title="usuário(CPF)"></td><td><input name="usuario" type="text" id="usuario"/></td></tr>
			<tr><td><img src="./imagens/senha.png" width="50" height="50" title="senha"> </td><td><input name="senha" type="password" id="senha" /></td></tr>
			</table>
