	  ...
	  <li class="backcolor" data-type="control_text" id="id_56">
        <div id="cid_56" class="form-input-wide">
          <div id="text_56" class="form-html">
			...
			<tr><td><font color='#000000' face="verdana" size=2><b>Sit Documento: &nbsp </b></font></td><td><select name='sit_doc'><?php
  			echo "<option value='$sit_doc'>$sit_doc1</option>";
			...
			<tr><td><font color='#000000' face="verdana" size=2><b>Doc Validade: &nbsp </b></font></td><td><input name="docv" type="date" value="<?php echo $doc_validade;?>"></td></tr>
