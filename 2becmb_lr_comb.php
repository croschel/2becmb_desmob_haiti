...
<?php 
  if ($b1 != '%'){echo '<a href="2becmb_cadastra_abast.php?id_ficha='.$b1.'" title="Cadastrar Abastecimento" target="_blank"><button type="button">Cadastra Abastecimento</button><a/>';}?>
