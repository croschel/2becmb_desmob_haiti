...
<form class="jotform-form" action="2becmb_balterar_foto.php" method="post" name="teste"  enctype="multipart/form-data" id="" accept-charset="utf-8" novalidate="true">
	  ...
	  <li class="backcolor" data-type="control_text" id="id_56">
        <div id="cid_56" class="form-input-wide">
          <div id="text_56" class="form-html">
			...
			<tr><td><?php echo '<font color="#000000" face="verdana" size=2>Anexar Foto:</font></td><td><input type="file" name="arquivo" />';?></td></tr>
