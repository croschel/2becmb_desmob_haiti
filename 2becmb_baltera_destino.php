...
<form class="jotform-form" action="2becmb_balterar_destino.php" method="post" name="teste"  enctype="multipart/form-data" id="" accept-charset="utf-8" novalidate="true">
  ...
  <div class="form-all">
    <table align="center" border="0" width="100%" class="backcolor1">
		...
		<td colspan="2"><font color='#000000' size="5" face="verdana">Batalhão Borba Cidade de Campinas </font><hr width="100%" align="left"></td>
		</tr>
		<tr>
	  ...
	  <li class="backcolor" data-type="control_text" id="id_56">
        <div id="cid_56" class="form-input-wide">
          <div id="text_56" class="form-html">
			...
			<tr><td><font color='#000000' face="verdana" size=2>Destino:</font></td><td><input name="destino" type="text" id="destino" value="<?php echo $destino;?>" ></td></tr>
